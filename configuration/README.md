# Clusters Setup
This is a prototype environment based on single and multi nodes clusters. The nodes are VirtualBoxes VMs managed with the my iso and VM customization scripts found in the [vm-mgmt](https://github.com/plawson/vm-mgmt) repo.
