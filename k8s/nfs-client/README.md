...
**Credits:** This is an exerpt of the [external-storage](https://github.com/kubernetes-incubator/external-storage/tree/v5.1.0/nfs-client) repository. The rbac.yaml and deployment.yaml have been modified to suit my environment.
